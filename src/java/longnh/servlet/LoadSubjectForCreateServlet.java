 ...
 * @author LongNH
 */
@WebServlet(name = "LoadSubjectForCreateServlet", urlPatterns = {"/LoadSubjectForCreateServlet"})
public class LoadSubjectForCreateServlet extends HttpServlet {

    private final String CREATE_PAGE = "create-question-page.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            log("LoadSubjectForCreateServlet _ " + ex.getMessage());
            url = ERRORS;
