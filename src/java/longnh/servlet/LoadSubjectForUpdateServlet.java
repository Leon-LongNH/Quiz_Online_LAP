 ...
 * @author LongNH
 */
@WebServlet(name = "LoadSubjectForUpdateServlet", urlPatterns = {"/LoadSubjectForUpdateServlet"})
public class LoadSubjectForUpdateServlet extends HttpServlet {

    private final String CREATE_PAGE = "update-subject-page.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            log("LoadSubjectForUpdateServlet _ " + ex.getMessage());
            url = ERRORS;
